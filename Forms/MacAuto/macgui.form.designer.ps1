...
[System.Windows.Forms.CheckBox]$chkWhatIf = $null
[System.Windows.Forms.CheckBox]$chkConfirm = $null
...
$chkWhatIf = (New-Object -TypeName System.Windows.Forms.CheckBox)
$chkConfirm = (New-Object -TypeName System.Windows.Forms.CheckBox)
$form1.SuspendLayout()
#
# lblMAC
#
...
# chkWhatIf
#
$chkWhatIf.Location = (New-Object -TypeName System.Drawing.Point -ArgumentList @([System.Int32]12,[System.Int32]40))
$chkWhatIf.Name = [System.String]'chkWhatIf'
$chkWhatIf.Size = (New-Object -TypeName System.Drawing.Size -ArgumentList @([System.Int32]100,[System.Int32]23))
$chkWhatIf.TabIndex = 3
$chkWhatIf.Text = 'WhatIf'
$chkWhatIf.UseCompatibleTextRendering = $true
$chkWhatIf.UseVisualStyleBackColor = $true
#
# chkConfirm
#
$chkConfirm.Location = (New-Object -TypeName System.Drawing.Point -ArgumentList @([System.Int32]12,[System.Int32]70))
$chkConfirm.Name = [System.String]'chkConfirm'
$chkConfirm.Size = (New-Object -TypeName System.Drawing.Size -ArgumentList @([System.Int32]100,[System.Int32]23))
$chkConfirm.TabIndex = 4
$chkConfirm.Text = 'Confirm'
$chkConfirm.UseCompatibleTextRendering = $true
